...
def get_wifi_passwords():
    ...
    output_profiles = subprocess.run(["netsh", "wlan", "show", "profiles"], capture_output=True, text=True, shell=True)
    profile_names = [line.split(":")[1].strip() for line in output_profiles.stdout.splitlines() if "Perfil de todos los usuarios" in line]
    wifi_passwords = []
